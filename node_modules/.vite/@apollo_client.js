    ...
    module2.exports = shouldUseNative() ? Object.assign : function(target, source) {
      ...
      for (var s = 1; s < arguments.length; s++) {
        ...
        for (var key in from2) {
          if (hasOwnProperty7.call(from2, key)) {
            to[key] = from2[key];
          }
        }
...
function useLazyQuery(query, options) {
  ...
  var execute2 = (0, import_react3.useCallback)(function(executeOptions) {
    ...
    return result2.refetch(executeOptions === null || executeOptions === void 0 ? void 0 : executeOptions.variables).then(function(result1) {
...
function useSubscription(subscription, options) {
  ...
  (0, import_react5.useEffect)(function() {
    ...
    if ((options === null || options === void 0 ? void 0 : options.skip) && !(options === null || options === void 0 ? void 0 : options.skip) !== !((_a6 = ref.current.options) === null || _a6 === void 0 ? void 0 : _a6.skip)) {
      setResult({
        loading: false,
        data: void 0,
        error: void 0,
